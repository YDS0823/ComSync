...
if __name__ == "__main__":
    test = "Configure a sslConfig.Builder for the server using the legacy configuration"
    print(Tokenizer.tokenize_desc_with_con(test))
